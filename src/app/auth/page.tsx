...
export default function Auth() {
    return (
        <div className="content-box ">
            <div className="flex flex-col max-sm:items-center max-sm:w-full sm:w-xl flex flex-col gap-4 mx-auto shadow-2 border-round bg-[var(--surface-card)] rounded-lg">
